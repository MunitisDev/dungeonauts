...
const STRINGS = {
  ...
  'event.mechanismOn': { es: '¡El mecanismo se enciende!', en: 'The mechanism lights up!' },
  'event.heartFound': { es: '¡Has recuperado un corazón!', en: 'You got a heart back!' },
  'event.levelUp': { es: '¡Has subido a nivel', en: 'You reached level' },
  'prompt.roomLocked': {
    es: 'Todavía queda algo por hacer en esta sala',
    en: 'There is still something to do in this room',
  },
  'hud.level': { es: 'Nivel', en: 'Level' },
  'complete.level': { es: 'Nivel', en: 'Level' },
